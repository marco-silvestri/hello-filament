...
<form class="items-center max-w-lg bg-shade-500 p-4 rounded-lg" action='{{ route("search") }}' method="GET" autocomplete="off">  
    ...
    <div class="relative w-full">
        ...
        <input type="text" id="kr" name="kr" value="{{$searchKey}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm  focus:ring-brand-500 focus:border-brand-500 block w-full ps-10   dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-brand-500 dark:focus:border-brand-500" placeholder="" required />
